...
JNIEXPORT void JNICALL Java_jrapl_PerfCheckUtils_perfInit(JNIEnv * env, jclass jcls, jint numEvents, jint isSet) {
	setGroup(isSet);
...
JNIEXPORT void JNICALL Java_jrapl_PerfCheckUtils_groupPerfEventsCheck(JNIEnv * env, jclass jcls, jstring name) {
...
JNIEXPORT void JNICALL Java_jrapl_PerfCheckUtils_singlePerfEventCheck(JNIEnv * env, jclass jcls, jstring name) {
	char *eventName;
	char *event[num_events];
	int i = 0;
	int id = 0;
...
JNIEXPORT void JNICALL Java_jrapl_PerfCheckUtils_perfEnable(JNIEnv * env, jclass jcls) {
	if (enabled) {
...
JNIEXPORT void JNICALL Java_jrapl_PerfCheckUtils_perfDisable(JNIEnv * env, jclass jcls) {
	if (!enabled) {
...
JNIEXPORT void JNICALL Java_jrapl_PerfCheckUtils_perfSingleRead(JNIEnv * env, jclass jcls, jint id, jlongArray buffer) {
...
JNIEXPORT void JNICALL Java_jrapl_PerfCheckUtils_perfMultRead(JNIEnv * env, jclass jcls, jlongArray buffer) {
...
JNIEXPORT jlongArray JNICALL Java_jrapl_PerfCheckUtils_processMultiValue(JNIEnv * env, jclass jcls, jlongArray buffer) {
...
JNIEXPORT jlong JNICALL Java_jrapl_PerfCheckUtils_processSingleValue(JNIEnv * env, jclass jcls, jlongArray buffer) {
